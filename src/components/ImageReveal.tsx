    ...
    <>
      ...
      >
        ...
        <div className="sticky top-0 left-0 w-full h-screen overflow-hidden flex flex-col md:flex-row bg-black">
          ...
          <div className="w-full md:w-1/2 h-full flex flex-col justify-between p-4 md:p-16 lg:p-24 z-10 select-none text-white!">
          ...
          <div 
            ...
            className="w-full md:w-1/2 h-full relative overflow-hidden bg-black cursor-crosshair"
          >
